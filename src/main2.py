...
# def midpoint_eval(i):
#    if (i + 1) % 200 == 0:
#        evaluate.evaluate_model(cnn_domain_transfer_net,
#                                encode.encode_cnn_dt_label,
...
##########
##########
# Uncomment for part 2.3.1.b: Train on askubuntu and evaluate android,
